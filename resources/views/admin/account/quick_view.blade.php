              ...
              <div class="col-md-4">
                <div class="form-group col-md-12">
                  ...
                  <div class="form-group">  
                         <select class="form-control" id="role_select_box"  data-table-without-pagination-disable-sorting="menu_role_table" multiselect-form="true"  name="role"  onchange="callAjax(this,'{{route('admin.account.role.default.quick.menu')}}'+'?id='+this.value,'menu_list')" > 
