...
@section('body')
  ...
  <section class="content-header">
    <button type="button" class="btn btn-info pull-right" multi-select="true" onclick="callPopupLarge(this,'{{ route('admin.award.for.addform')}}')" style="margin:10px">Add</button>
