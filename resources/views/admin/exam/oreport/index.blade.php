...
<section class="content-header">
    ...
    <section class="content">
        <div class="box"> 
            <div class="box-body">
            <form action="{{ route('admin.exam.report.filter') }}" method="post" class="add_form"  success-content-id="filter_table_show" no-reset="true" data-table-without-pagination="class_test_show_table_id">
            {{ csrf_field() }} 
                <div class="row">
                  <div class="col-lg-3">
