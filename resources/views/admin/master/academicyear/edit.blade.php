...
<div class="modal-content" >
  ...
  <div class="modal-body">
     <form id="act_add" content-refresh="table_academic_year" button-click="btn_close" method="post" action="{{ route('admin.academicYear.update',Crypt::encrypt(@$academicYear->id? @$academicYear->id : 0)) }}" class="add_form" no-reset="true" button-click="btn-submit">
               {{ csrf_field() }}
