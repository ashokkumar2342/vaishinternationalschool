...
@section('body')
  ...
  <section class="content-header">
    <button type="button" class="btn btn-info pull-right" onclick="callPopupLarge(this,'{{ route('admin.event.type.add.form')}}')" style="margin:10px">Add Form</button>
    <h1>Event Type<small>List</small> </h1>
