                        ...
                        <tr>
                          ...
                          <td>
                            @if(App\Helper\MyFuncs::menuPermission()->w_status == 1) 
                              ...
                              <a href="{{ route('admin.hr.master.it.slab.delete',Crypt::encrypt($IncomeTax->id)) }}" class="btn btn-danger btn-xs" title="Delete" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"></i></a>
                              @endif 
                        </tr> 
                  @endforeach
                </tbody>
