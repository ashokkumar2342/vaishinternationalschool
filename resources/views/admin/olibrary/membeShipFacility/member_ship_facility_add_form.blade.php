  ...
  <div class="modal-dialog" style="width:90%">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Add Member Ship Facility </h4>
      </div>
          ...
          <form action="{{ route('admin.library.member.ship.facility.store') }}" method="post" class="add_form" button-click="btn_member_ship_facility_table_show,btn_close">
                   ...
                   <div class="row">
                    ...
                    <div class="form-group col-lg-4">
                      ...
                      <input type="text" name="no_of_ticket" class="form-control"  placeholder="Enter No of Tickets" maxlength="10" onkeypress='return event.charCode >= 48 && event.charCode <= 57'> 
                    </div>
                    <div class="form-group col-lg-4">
                      <label>No of Days</label>
                      <input type="text" name="no_of_days" class="form-control" maxlength="10" placeholder="Enter No of Days" onkeypress='return event.charCode >= 48 && event.charCode <= 57'> 
                    </div> 
