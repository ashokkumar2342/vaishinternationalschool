<table class="table table-hover table-condensed table-striped" id="slc_datatable">
     ...
     <tbody>
          ...
          <tr>
               <td>
                    <a onclick="callPopupLarge(this,'{{ route('admin.student.BirthCertificateApprovalTake',$DOBCertIssueDetail->id) }}')">{{ $DOBCertIssueDetail->students->registration_no or '' }}
                    </a>
               </td>
               ...
               <td>
                <a onclick="callPopupLarge(this,'{{ route('admin.student.BirthCertificateApprovalTake',$DOBCertIssueDetail->id) }}')" class="btn-xs btn btn-primary">Take Action</a>
               </td>
          </tr>
          @endforeach
     </tbody>
