<table id="dataTable" class="table table-striped table-hover table-responsive">
                  ...
                  <tr>
                    ...
                    <td>
                      <a onclick="callPopupLarge(this,'{{ route('admin.student.CharacterCertificateIssueTake',$CharCertIssueDetails->id) }}')">{{ $CharCertIssueDetails->students->registration_no or ''}}</a>
                      </td> 
                    ...
                    <td class="text-nowrap"> 
                       <a class="btn btn-primary btn-xs" onclick="callPopupLarge(this,'{{ route('admin.student.CharacterCertificateIssueTake',$CharCertIssueDetails->id) }}')">Take Action</a>
                   </td> 
                  </tr>
                  @endforeach
                  </tbody>
