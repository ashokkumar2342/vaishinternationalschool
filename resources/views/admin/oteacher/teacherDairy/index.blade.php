...
<section class="content-header">
   <button type="button" class="btn btn-info pull-right "  select2="true"  onclick="callPopupLarge(this,'{{ route('admin.teacher.appointment.addFprm')}}')"  >Add Form</button> 
  <h1>Appoinment<small>List</small> </h1> 
</section>  
