          ...
          <div class="box"> 
            <div class="box-body"> 
              <div class="row">
                ...
                <select name="teacher_name" id="teacher_id" class="form-control" onchange="callAjax(this,'{{ route('admin.teacher.working.schedule.show') }}'+'?time_table_type_id='+$('#time_table_type_id').val()+'&teacher_id='+$('#teacher_id').val(),'teacher_working_schedule_show')">
