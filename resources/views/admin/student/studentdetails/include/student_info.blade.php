<div class="row"> 
  <div class="col-lg-9">
    <div  class="col-lg-6 form-group">
      <label>Registration No.</label> :: {{ $student[0]->registration_no }}
    </div>
    <div  class="col-lg-6 form-group">
      <label>Admission No.</label> :: {{$student[0]->admission_no}}
    </div>
    ...
    <div  class="col-lg-6 form-group">
      <label>Class</label> :: {{ $student[0]->class }} - {{ $student[0]->section }}
    </div>
    <div  class="col-lg-6 form-group">
      <label>Roll No.</label> :: {{$student[0]->roll_no}}
    </div>

    <div  class="col-lg-6 form-group">
      <label>Admission Date</label> :: {{ $student[0]->date_of_admission }}
    </div>
    <div  class="col-lg-6 form-group">
      <label>Status</label> :: {{$student[0]->status}}
    </div>
    ...
    <div  class="col-lg-6 form-group">
      <label>Gender</label> :: {{$student[0]->genders}}
    </div>
    ...
    <div  class="col-lg-6 form-group">
      <label>House</label> :: {{$student[0]->house}}
    </div>
  </div>  
