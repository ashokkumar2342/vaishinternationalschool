        ...
        <div class="col-lg-8">
          <div class="panel panel-default" style="background-color:#c0b2b5">
            <div class="panel-heading">
              <div class="btn-group">
                <a  id="student_info_tab" class="btn btn-primary" style="border-color: #da110d;background-color: #4e6877;" onclick="callAjax(this,'{{ route('admin.helpdesk.school.student.info',Crypt::encrypt($studentId)) }}','tab_info_detail')"><i class="fa fa-user"></i> Student</a>
          ...
          <div class="panel panel-default">
            <div class="panel-heading">
              <div class="btn-group">
                ...
                <a href="{{ route('admin.helpdesk.school.admission.download',Crypt::encrypt($studentId)) }}" class="btn btn-primary" style="border-color: #da110d;background-color: #4e6877;" title="Download Profile " target="_blank" ><i class="fa fa-download"></i> Download Profile</a>
