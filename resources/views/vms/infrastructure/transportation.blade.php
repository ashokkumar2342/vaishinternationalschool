...
<img src="{{asset('images/vis/transportation/Transportation.jpg')}}" alt="Top banner" class="img-fluid"> 	
</div>
<!-- Breadcrumb ============================== -->
...
<h2 class="pg-hd text-center wow fadeInDown"><span>TRANSPORTATION</span></h2>
</div>
<div class="col-md-3 pg-sidebar wht-bg p-0">
	<h3 class="pg-sb-hd text-center mb-3 pt-3 wow fadeInDown">Transportation</h3>
	<ul class="pg-links">  
		<li class="">
...
<p>The school has its own comfortable buses, eight in number, which operate within city limits. The students can avail bus facility subject to the availability of seats.</p>
<p>The buses are well equipped with C.C.T.V., G.P.S., Fire Alarm, Fire Extinguishes, First Aid Box, Tool Box and undergo safety checks from time to time.</p>

<p>&nbsp;</p>
<p><img src="{{asset('images/vis/transportation/Transportation1.jpg')}}" alt="opentheater1" width="450" height="232" style="display: block; margin-left: auto; margin-right: auto;" /></p>
<p>&nbsp;</p>

<p style="text-align: justify;">The school has its own comfortable buses, eight in number, which operate within city limits. The students can avail bus facility subject to the availability of seats.</p>
<p>&nbsp;</p>
<p style="text-align: justify;">The buses are well equipped with C.C.T.V., G.P.S., Fire Alarm, Fire Extinguishes, First Aid Box, Tool Box and undergo safety checks from time to time.</p>
<p>&nbsp;</p>
