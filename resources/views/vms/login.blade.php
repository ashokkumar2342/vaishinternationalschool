...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="background:url('{{asset('images/institute_glimpse.jpg')}}');background-repeat: no-repeat;background-size: cover;background-position: center;">
	...
	<div class="LoginBox" style="max-height: 700px;height: 60vh;width: 40vw;border-width:7px;border-color:#012643;border-top-right-radius: 50px;border-bottom-left-radius: 50px;background:#EBF6FA;left: 55%;top:15%">
		<div style="background:#EBF6FA;">
			...
			<div class="LoginTopClient" style="background: #EBF6FA;">
				<center>
					<FONT SIZE="+1"  face="Calibri" style="font-size:14px"
					>Login / Sign Up <span style="color:green;">{{ $errors->first() }}</span></FONT>
				</center>
			</div>

			<form  action="{{route('vms.login.post')}}" method="post">
			{{csrf_field()}}
					...
					<table border="0" cellpadding="2" align="center" cellspacing="2" height="50%" width="100%" style="border-collapse: collapse; vertical-align: top;">
						...
						<tr>
							<td colspan="2" style="vertical-align: middle" align="center" height="25">
								<input type="email" name="email" style="font-size: 12px border:1px; background-color: #F3F3F3; width: 304px; height: 30;color: #990000;border:1px solid black;"  placeholder="Email Id" required>
									<p class="text-danger" style="color:red">{{ $errors->first('email') }}</p>
							</td>
						</tr>
						<tr>
							<td colspan="2" style="vertical-align: middle" align="center" height="25">
								<input type="password" name="password" style="font-size: 12px border:1px; background-color: #F3F3F3; width: 304px; height: 30;color: #990000;border:1px solid black;" placeholder="Password" required>
						...
						<tr>
							<td colspan="2" align="center" height="15">
								...
								<div class="input-group mb-3" style="margin-top: 5px">
								   <input id="captcha" name="captcha" type="text" style="font-size: 12px border:1px; background-color: #F3F3F3; width: 304px; height: 30;color: #990000;border:1px solid black;" placeholder="Enter Captcha" required>
						...
						<tr>
							<td width="70%" align="center" height="25">
								...
								<i class="material-icons blue600">assignment_ind</i>&nbsp;&nbsp;Login</button>
							</td>
						</tr>
						<tr>
							<td height="25" colspan="2" valign="bottom" align="center" id="trCanAccess" onclick="/*showPassPhrage();*/" style="vertical-align: middle; font-size: 14px; font-family: Tahoma; color: blue">
								<a border="0"  onclick=""  class="mdl-button--fgt" onmouseover="this.style.color='red';" onmouseout="this.style.color='#00008B';" style="width: 304px; height: 100%; background-color: rgb(226, 245, 252); color: rgb(0, 0, 139); font-weight: bold;">&nbsp;&nbsp;Forgot
									Password?</a>
							</td>
						</tr>
						<tr>
							<td height="25" colspan="2" valign="bottom" align="center" id="trCanAccess" onclick="/*showPassPhrage();*/" style="vertical-align: middle; font-size: 14px; font-family: Tahoma; color: blue">
								<a border="0"  href="{{route('student.resitration.firststep')}}"  class="mdl-button--fgt" onmouseover="this.style.color='red';" onmouseout="this.style.color='#00008B';" style="width: 304px; height: 100%; background-color: rgb(226, 245, 252); color: rgb(0, 0, 139); font-weight: bold;">&nbsp;&nbsp;New Admintion</a>
							</td>
						</tr>
					</table>
				</div>
