...
<h2 class="pg-hd text-center wow fadeInDown"><span>CALENDER & EVENTS</span></h2>
</div>
<div class="col-md-3 pg-sidebar wht-bg p-0">
	<h3 class="pg-sb-hd text-center mb-3 pt-3 wow fadeInDown">Calendar & Events</h3>
	<ul class="pg-links">  
		<li class="">
...
<h4><strong><span style="color: #000000;"><a href="{{asset('images/activities/Activities_for_the_year_2017_chart_(junior).docx')}}" style="color: #000000;">Click here for Activities for the Year 2017-18 for Junior Wing</a></span></strong></h4>	
