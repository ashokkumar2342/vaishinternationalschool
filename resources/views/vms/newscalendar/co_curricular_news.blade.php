...
<li class="breadcrumb-item"><a href="#">Co-Curricular News</a></li>  
...
<h2 class="pg-hd text-center wow fadeInDown"><span>CO-CURRICULAR NEWS</span></h2>
</div>
<div class="col-md-3 pg-sidebar wht-bg p-0">
	<h3 class="pg-sb-hd text-center mb-3 pt-3 wow fadeInDown">Co-Curricular News</h3>
	<ul class="pg-links">  
		<li class="">
...
<ul>
	<li>
		School is going to organise Summer Camp for III to VIII for the all a round development of the students by involving different activities like Dance, English Conversation, Painting, Drama, Mehandi, Music, Cursive Writing, Craft, Yoga and Games/Sports from 1st June to 7th June, 2017.
	</li>
