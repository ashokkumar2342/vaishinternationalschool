...
<li class="breadcrumb-item"><a href="#">Sports News</a></li>  
...
<h2 class="pg-hd text-center wow fadeInDown"><span>SPORTS NEWS</span></h2>
</div>
<div class="col-md-3 pg-sidebar wht-bg p-0">
	<h3 class="pg-sb-hd text-center mb-3 pt-3 wow fadeInDown">Sports News</h3>
	<ul class="pg-links">  
		<li class="">
...
<p>INFORMATION AND PHOTOS OF SPORTS ACTIVITIES</p>
